...
{
    /// <summary>
    /// This class aims to manage a Pool of Virtual Machines. Singleton pattern, access by Instance Property.
    /// </summary>
    class VMManager
    {
        /// <summary>
        /// Private instance field, retured by the Instance Property
        /// </summary>
        private static VMManager _instance;

        /// <summary>
        /// Point of access for the Singleton Pattern
        /// </summary>
        ...
        /// <summary>
        /// This list contains the actual created vms.
        /// </summary>
        private List<VBoxVM> _vms;

        /// <summary>
        /// Constructor private: instantiate the manager with default parameters (contants)
        /// </summary>
        private VMManager()
        {
            _vms = new List<VBoxVM>();
        }

        private enum VMStatus
        {
            Uninitialized,
            Ready,
            Running
        ...
        public void RevertVm(string vmName)
        {
            // Look for a VM with that name and execute the revert
            foreach (VBoxVM vm in _vms)
            {
                if (vm.Name==vmName)
                {
                    vm.Revert();
            ...
            throw new ArgumentException("No VM found with that name: "+vmName);
        }
        ...
        { 
            ...
            // If I get here, no VM is free, so create a new one
            VBoxVM v = new VBoxVM(Settings.Default.BASE_NAME+_vms.Count);
            v.InitiateByCloning();
            _vms.Add(v);
            v.Start();
        }
